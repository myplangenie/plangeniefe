  ...
  return (
    <div className="py-16 md:py-24 text-black">
      ...
      <div className="max-w-[1470px] px-5 sm:px-10 md:px-16 mx-auto mt-8 md:mt-10 font-manrope">
        ...
        <Link className="text-sm bg-accent flex items-center gap-2 mt-6 font-bold py-4 px-6 rounded-[8px] text-white w-max mx-auto" href="/plan">Join Our Movement <FaArrowRightLong /></Link>
      </div>
    </div>
  );
}
