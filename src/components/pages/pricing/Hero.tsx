    ...
    <div className="bg-primary pt-48 pb-28 text-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center gap-4">
          <ul className="text-xs sm:text-sm opacity-80 mb-4 flex gap-4 flex-wrap justify-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-7xl font-extrabold font-manrope tracking-tight mb-7">
